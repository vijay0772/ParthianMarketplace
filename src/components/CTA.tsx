      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-white">Join 100,000+ Happy Users</span>
          </motion.div>
          ...
          >
            ...
            <br />
            <span className="inline-block mt-2">Battery Business?</span>
          </motion.h2>
          ...
          >
            Join thousands of sellers and buyers who trust Parthian Marketplace for their battery trading needs. Start today with no setup fees.
          </motion.p>
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button 
                size="lg" 
                className="bg-white text-primary hover:bg-white/90 px-8 py-6 text-lg rounded-xl shadow-2xl group"
              >
                Get Started Free
