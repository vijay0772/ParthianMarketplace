...
export function BuyerLogin() {
  ...
  const stats = [
    ...
    { icon: ShoppingCart, value: "100K+", label: "Buyers" }
  ];
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 backdrop-blur-xl mb-6">
              ...
              <span className="text-sm text-cyan-400 font-medium">Buyer Portal</span>
            </div>
            ...
            <p className="text-xl text-slate-400 mb-12 leading-relaxed">
              Continue your shopping journey and discover the perfect battery solutions for your needs.
            </p>
            ...
            <motion.div
              ...
              className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-emerald-500/10 border border-cyan-500/20 backdrop-blur-xl"
            >
              <h3 className="text-white font-semibold mb-2">🎉 Special Offer!</h3>
              <p className="text-slate-400 text-sm">Get 15% off your first order. Use code: WELCOME15</p>
            </motion.div>
          </motion.div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-900/90 backdrop-blur-xl border border-cyan-500/20 rounded-3xl p-8 sm:p-12 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-white mb-2">Buyer Sign In</h2>
                  <p className="text-slate-400">Access your account and continue shopping</p>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="h-4 w-4 rounded border-slate-700 bg-slate-800 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-slate-900"
                      />
                ...
                <div className="mt-8 text-center">
                  <p className="text-slate-400">
                    ...
                    <Link to="/buyer/signup" className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
                      Sign up
                    </Link>
                  </p>
                </div>
